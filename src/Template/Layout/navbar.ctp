     <ul class="sidebar-menu">
        ...
        <li><a target="_self" href="/admin/dashboard"><i class="fa fa-dashboard"></i>  <span>Dashboard</span></a></li>
        <li class="treeview"><a href="/admin/catalog/items"><i class="fa fa-tag"></i> <span >Catalog</span>
          ...
          <li><a target="_self" href="/admin/catalog/items">Items</a></li>
            ...
            <li><a target="_self" href="color.php">Colors</a></li>
            <li><a target="_self" href="sizes.php">Sizes</a></li>
          </ul>
